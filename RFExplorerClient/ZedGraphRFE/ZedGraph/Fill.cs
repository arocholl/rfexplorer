                ...
                else if ( IsGradientValueType )
                {
                    if ( dataValue != null )
                    {
                        if ( !_secondaryValueGradientColor.IsEmpty )
                        {
                            ...
                            return new Fill( _secondaryValueGradientColor,GetGradientColor( dataValue ), _angle ).MakeBrush( rect );
                        }
                        else
                    ...
                    else if ( _rangeDefault != double.MaxValue )
                    {
                        if ( !_secondaryValueGradientColor.IsEmpty )
                        {
                            // Go ahead and create a new Fill so we can do all the scaling, etc.,
                            // that is associated with a gradient
                            return new Fill( _secondaryValueGradientColor, GetGradientColor( _rangeDefault ), _angle ).MakeBrush( rect );
                        }
                        else
