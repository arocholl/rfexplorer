...
namespace ZedGraph
{
	...
	/// 
	[Serializable]
    public class GraphPane : PaneBase, ICloneable, ISerializable, IDisposable
	{
	...
	#region Private Fields
		...
		/// <summary>
		/// Defines the angle of a gas gauge
		/// </summary>
		protected float m_angle;
		
		/// <summary>
		/// Defines the width of the border of the gauge line
		/// </summary>
		protected float m_gasGaugeRegionWidth;
		
		/// <summary>
		/// Defines whether there is a black border around the gauge
		/// </summary>
		protected bool m_gasGaugeBorder;
		
		/// <summary>
		/// Defines whether the current value of the angle is being shown on the graph
		/// </summary>
		protected bool m_showGasGaugeValueLabel;
		
		/// <summary>
		/// Defines whether the gauge is being drawn clockwise or not
		/// </summary>
		protected bool m_clockwise;
		
		/// <summary>
		/// Defines whether the gauge has labels showing the limits of the regions
		/// </summary>
		protected bool m_hasLabel;
		
		/// <summary>
		/// The angle in which the pie chart will be drawn
		/// 90 degrees gives a view from straight up and 0 degrees from the side
		/// </summary>
		protected float m_watchAngle;
		
		/// <summary>
		/// The height of the side of the pie
		/// </summary>
		protected double m_pieHeight;
		
		/// <summary>
		///Private field which holds the first angle of the portion that is already used for the slice
		/// </summary>
		protected float m_usedAngleBegin;
		
		/// <summary>
		///Private field which holds the second angle of the portion that is already used for the slice
		/// </summary>
		protected float m_usedAngleEnd;
	...
	#region Defaults
		...
		public new struct Default
		{
			...
			/// <summary>
			/// The default value for the angle of a gas gauge
			/// </summary>
			public static float Angle = 270.0f;
			
			/// <summary>
			/// The default angle in which the pie chart will be drawn
			/// </summary>
			public static float WatchAngle = 90.0f;
		
			/// <summary>
			/// The default height of the side of the pie
			/// </summary>
			public static double PieHeight = 20;
			
			/// <summary>
			/// Show the labels of the region limits
			/// </summary>
			public static bool HasLabel = false;
			
			/// <summary>
			/// The default value for the width of the border of a gas gauge
			/// </summary>
			public static float GasGaugeRegionWidth = 10.0f;
			
			/// <summary>
			/// The default value for the black border around the gauge
			/// </summary>
			public static bool GasGaugeBorder = true;
			
			/// <summary>
			/// The default value for the value label on the gauge
			/// </summary>
			public static bool ShowGasGaugeValueLabel = true;
			
			/// <summary>
			/// The default value for drawing clockwise or not
			/// </summary>
			public static bool Clockwise = false;
			
			/// <summary>
			/// The default first angle of the portion that is already used for the slice
			/// </summary>
			public static float UsedAngleBegin = 90;
			
			/// <summary>
			///The default second angle of the portion that is already used for the slice
			/// </summary>
			public static float UsedAngleEnd = 90;
	...
	#region General Properties
		...
		/// <summary>
		/// Gets or sets the Angle of a gas gauge
		...
		/// <summary>
		/// Gets or sets the angle in which the pie chart will be drawn
		/// </summary>
		public float WatchAngle
		{
			get { return ( m_watchAngle ); }
			set { m_watchAngle = value; }
		}
		
		/// <summary>
		/// Gets or sets the height of the side of the pie
		/// </summary>
		public double PieHeight
		{
			get { return ( m_pieHeight ); }
			set { m_pieHeight = value; }
		}
		
		/// <summary>
		/// Gets or sets whether the labels for the
		/// region limits will be drawn
		/// </summary>
		public bool HasLabel
		{
			get { return ( m_hasLabel ); }
			set { m_hasLabel = value; }
		}
		
		/// <summary>
		/// Gets or sets whether the gas gauge has a black circle
		/// </summary>
		public bool GasGaugeBorder
		{
			get { return ( m_gasGaugeBorder ); }
			set { m_gasGaugeBorder = value; }
		}
		
		/// <summary>
		/// Gets or sets whether there is a label in the middle showing the
		/// actual value for the gas gauge needle
		/// </summary>
		public bool ShowGasGaugeValueLabel
		{
			get { return ( m_showGasGaugeValueLabel ); }
			set { m_showGasGaugeValueLabel = value; }
		}
		
		/// <summary>
		/// Gets or sets the value for the value of the gas gauge
		/// </summary>
		public bool Clockwise
		{
			get { return ( m_clockwise ); }
			set { m_clockwise = value; }
		}
		
		/// <summary>
		///Gets or sets the first angle of the portion that is already used for the slice
		/// </summary>
		public float UsedAngleBegin
		{
			get { return ( m_usedAngleBegin ); }
			set { m_usedAngleBegin = value; }
		}
		
		/// <summary>
		///Gets or sets the second angle of the portion that is already used for the slice
		/// </summary>
		public float UsedAngleEnd
		{
			get { return ( m_usedAngleEnd ); }
			set { m_usedAngleEnd = value; }
		}
		
		/// <summary>
		/// Gets or sets the width of the border of the gas gauge
		/// </summary>
		public float GasGaugeRegionWidth
		{
			get { return ( m_gasGaugeRegionWidth ); }
			set { m_gasGaugeRegionWidth = value; }
		}
	...
	#region Constructors
			...
			: base( rhs )
		{
			...
			m_usedAngleBegin = rhs.m_usedAngleBegin;
			m_usedAngleEnd = rhs.m_usedAngleEnd;
		}
	...
	#region General Utility Methods
        ...
        /// of ArrowObj and <see cref="CurveItem"/>, within
        ...
        /// <see cref="TextObj"/>, ArrowObj, or <see cref="CurveItem"/>.
