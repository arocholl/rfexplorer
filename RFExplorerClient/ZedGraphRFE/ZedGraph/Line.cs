...
namespace ZedGraph
{
    ...
    [Serializable]
    public class Line : LineBase, ICloneable, ISerializable, IDisposable
    {
    ...
    #region Fields
        ...
        /// <summary>
        /// Determines whether the _fill switch will work standard (false) filling from the X axis or if
        /// it will fill from the bottom of the pane - which is good for negative growing curves as in a spectrum analyzer
        /// </summary>
        private bool _fillFromBottom;
    ...
    #region Properties
        ...
        /// <summary>
        /// Determines whether the <see cref="ZedGraph.Fill"/> switch will work standard (false) filling from the X axis or if
        /// it will fill from the bottom of the pane (true) - which is good for negative growing curves as in a spectrum analyzer
        /// </summary>
        public bool FillFromBottom
        {
            get { return _fillFromBottom; }
            set { _fillFromBottom = value; }
        }
