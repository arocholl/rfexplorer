...
namespace ZedGraph
{
	...
	/// </summary>
	[Serializable]
    public class GasGaugeRegion : CurveItem, ICloneable, ISerializable, IDisposable
	{
		#region Fields

        TextObj m_LabelMin, m_LabelMax;

        bool m_bRotateLabels = false;
        /// <summary>
        /// Indicate whether labels should be rotated with angle or not
        /// </summary>
        public bool RotateLabels
        {
            get { return m_bRotateLabels; }
            set { m_bRotateLabels = value; }
        }

        bool m_bHasLabel = false;
        /// <summary>
        /// This is individual field for this gauge region to display min/max labels. Note there is another
        /// global HasLabel property in the pane that can be used to set them all
        /// </summary>
        public bool HasLabel
        {
            get { return m_bHasLabel; }
            set { m_bHasLabel = value; }
        }
		...
		/// <summary>
		/// Defines the secondary Color of this <see cref="GasGaugeRegion"/>
		/// </summary>
			...
			: base( info, context )
		{
			...
			_color1 = (Color)info.GetValue( "color1", typeof( Color ) );
			_color2 = (Color)info.GetValue( "color2", typeof( Color ) );
		...
		public override void GetObjectData( SerializationInfo info, StreamingContext context )
		{
			...
			info.AddValue( "color1", _color1 );
			info.AddValue( "color2", _color2 );
		...
		/// <param name="color1">The display color for this <see cref="GasGaugeRegion"/> instance.</param>
		...
		public GasGaugeRegion( string label, double minVal, double maxVal, Color color1 )
			: base( label )
		{
			MinValue = minVal;
			MaxValue = maxVal;
			RegionColorStart = color1;
			RegionColorEnd = color1;
			StartAngle = 0f;
			SweepAngle = 0f;
			_border = new Border( Default.BorderColor, Default.BorderWidth );
			_border.IsVisible = Default.IsBorderVisible;
		...
		/// <param name="label">The value associated with this <see cref="GasGaugeRegion"/> instance.</param>
		/// <param name="color1">The display color for this <see cref="GasGaugeRegion"/> instance.</param>
		/// <param name="color2">The display secondary color for this <see cref="GasGaugeRegion"/> instance.</param>
		/// <param name="minVal">The minimum value of this <see cref="GasGaugeNeedle"/>.</param>
		/// <param name="maxVal">The maximum value of this <see cref="GasGaugeNeedle"/>.</param>
		public GasGaugeRegion( string label, double minVal, double maxVal, Color color1, Color color2 )
			: base( label )
		{
			MinValue = minVal;
			MaxValue = maxVal;
			RegionColorStart = color1;
			RegionColorEnd = color2;
			StartAngle = 0f;
			SweepAngle = 0f;
			_border = new Border( Default.BorderColor, Default.BorderWidth );
			_border.IsVisible = Default.IsBorderVisible;
		...
		/// <summary>
		/// Gets or sets the RegionColor1 of this <see cref="GasGaugeRegion"/>
		/// </summary>
		public Color RegionColorStart
		{
			get { return _color1; }
			set
			{
				_color1 = value;
				Fill = new Fill( _color1 );
			}
		}
		
		/// <summary>
		/// Gets or sets the RegionColor2 of this <see cref="GasGaugeRegion"/>
		/// </summary>
		public Color RegionColorEnd
		{
			get { return _color2; }
			set
			{
				_color2 = value;
				Fill = new Fill( _color2 );
			}
		}
...
//			public static PieLabelType LabelType = PieLabelType.Name;
	...
	#region Methods
		...
		/// </param>
		/// <param name="pos">Not used for rendering GasGaugeRegion</param>
