...
*/
    ...
    #region Methods
        ...
        */
        ...
        /// <summary>
        /// Returns the index of the highest value in the point pair list
        /// </summary>
        /// <returns></returns>
        ...
        /// <param name="dMax">Entry value will be considered Max, and if any is found to be higher this will be updated to that value</param>
        /// <param name="nPosMin">Position of the new Min value found, or -1 if none</param>
        /// <param name="nPosMax">Position of the new Max value found, or -1 if none</param>
        public void GetMaxMinValues(ref double dMin, ref double dMax, out int nPosMin, out int nPosMax)
        {
            nPosMin = -1;
            nPosMax = -1;
